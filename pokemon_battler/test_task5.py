...
class TestTask5(unittest.TestCase):
    ...
    def test___conduct_combat(self):
        ...
        t2._PokeTeam__assign_team("", 2, 2, 2)
        try:
            self.assertTrue(battle._Battle__conduct_combat(t1, t2, battle_mode) == 2, "Set Mode 1,0,0 vs 2,2,2 failed")
        except AssertionError as e:
            self.verificationErrors.append(str(e))
        ...
        try:
            self.assertTrue(battle._Battle__conduct_combat(t1, t2, battle_mode) == 0, "Set Mode 1,0,0 vs 1,0,0 failed")
        except AssertionError as e:
            self.verificationErrors.append(str(e))
